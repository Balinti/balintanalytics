    ...
    <ParallaxSection speed={0.2}>
      <section className="hero">
        <div className="hero-content">
          <ScrollReveal preset="slideUp" delay={0}>
            <h1 className="hero-title">BALINT ANALYTICS</h1>
          </ScrollReveal>

          <ScrollReveal preset="slideUp" delay={0.1}>
            <p className="hero-subtitle">Data, AI & BI</p>
          </ScrollReveal>

          <ScrollReveal preset="slideUp" delay={0.2}>
          ...
          <ScrollReveal preset="slideUp" delay={0.3}>
          ...
          <ScrollReveal preset="slideUp" delay={0.4}>
